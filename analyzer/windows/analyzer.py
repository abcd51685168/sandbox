...
class Analyzer:
    ...
    def prepare(self):
        ...
        log.info("options: %s" % self.config.get_options())
        log.info("options items: %s" % self.config.get_options().items())
